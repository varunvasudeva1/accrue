...
export default async function Index() {
  return (
    <div className="flex flex-col items-start justify-start w-full space-y-4">
      ...
      <p className="text-lg text-white leading-relaxed">
        We do not collect any personally identifiable information (PII) from our
        users. We require users to create an account with an email in order to
        use our services. We only collect information that is necessary for the
        operation of our platform, such as email addresses and user-generated
        content (project data, chat messages, etc.).
      </p>
      <h4 className="font-bold text-xl lg:text-2xl text-purple-200 pb-2">
      ...
      <p className="text-lg text-white leading-relaxed">
        ...
        protecting the privacy of our users and do not sell or share their data
        with anyone. This includes user information any user-generated content
        on our platform.
      </p>
      <h4 className="font-bold text-xl lg:text-2xl text-purple-200 pb-2">
      ...
      <p className="text-lg text-white leading-relaxed">
        We use functional cookies to enable a better user experience. We do not
        use any other tracking technologies to collect information about you.
      </p>
      <h4 className="font-bold text-xl lg:text-2xl text-purple-200 pb-2">
      ...
      <p className="text-lg text-white leading-relaxed">
        ...
        about you, but we do not share this information with them. We will only
        use these services if they are necessary for the operation of our
      ...
      <p className="text-lg text-white leading-relaxed">
        ...
        users of any changes to this policy by updating the "last updated" date
        at the top of this page and by sending an email to the email address
        associated with their account. We encourage users to review this policy
        frequently to stay informed about how we are protecting their
        information.
      </p>
      <h4 className="font-bold text-xl lg:text-2xl text-purple-200 pb-2">
        Contact Us
